...
public class TextToTextMeshPro : Editor
{
    ...
    static void DoIt()
    {
        ...
        foreach (GameObject gameObject in Selection.gameObjects)
        {
            if (recursive)
            {
                ...
                // added this because it seems the last text component in the prefab will be removed but its tmp counter part will not be added/saved
    ...
    static TextMeshProSettings GetTextMeshProSettings(Text uiText)
    {
        ...
        return new TextMeshProSettings
        {
            ...
            Font = (TMP_FontAsset)AssetDatabase.LoadAssetAtPath(AssetDatabase.GUIDToAssetPath(results[0]), typeof(TMP_FontAsset))
        };
    }
